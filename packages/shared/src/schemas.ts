...
export const UserPreferencesSchema = z.object({
  ...
  permissionMode: z.enum(["ask", "read_only", "full_access", "custom", "auto_approval"]).default("ask"),
  autoApprove: z.enum(["none", "low", "medium", "all"]).default("none"),
  autoApproveStrategy: z.enum(["ask", "read_only", "balanced", "custom", "all_safe"]).default("ask"),
  autoApproveRiskCategories: z.array(z.enum(["host_observation", "workspace_read", "workspace_write", "shell", "network"])).default([]),
