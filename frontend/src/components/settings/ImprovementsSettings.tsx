                    ...
                    <div className="flex min-w-0 items-center justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-xs text-text-secondary">
                          {proposal.kind.replace('_', ' ')} · {proposal.status.toLowerCase()} · Evidence: {proposal.evidenceTaskIds.length} · Review score: {proposal.reviewScore.toFixed(2)}
                        </p>
                      </div>
            ...
            {archive.slice(0, 4).map((entry) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs text-text-secondary">
                    Review score {entry.reviewScore.toFixed(2)} · {entry.patternKey}
                  </p>
                </div>
                <div className="shrink-0 text-right text-[11px] text-text-muted">
