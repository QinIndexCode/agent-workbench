...
export const EXECUTION_PROFILES: Record<ExecutionProfileId, ExecutionProfile> = {
  analyze: {
    ...
    allowedToolIds: ['read-file', 'list-files', 'search-files'],
  ...
  implement: {
    ...
    allowedToolIds: ['read-file', 'list-files', 'search-files', 'create-folder', 'write-file', 'run-command', 'delegate-subtask'],
  ...
  verify: {
    ...
    allowedToolIds: ['read-file', 'list-files', 'search-files', 'create-folder', 'write-file', 'run-command'],
