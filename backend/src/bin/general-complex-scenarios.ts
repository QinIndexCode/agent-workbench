import { runTaskGeneralComplexScenarioSuite } from '../application/benchmark';

function formatScenarioLine(result: Awaited<ReturnType<typeof runTaskGeneralComplexScenarioSuite>>['scenarios'][number]): string {
  return [
...
async function main(): Promise<void> {
  const report = await runTaskGeneralComplexScenarioSuite();
