...
1. Open **Skills** if you want to review reusable execution methods.
...
1. Keep **Memory** compact and accurate.
2. Add or clean **Knowledge** so retrieval has good source material.
3. Review **Curator** before activating a candidate skill.
4. Only then promote or merge items inside **Skills**.
